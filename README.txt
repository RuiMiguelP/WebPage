...
a persistence unit "project1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "project1\pom.xml":
...
artifact ("project1.war") is already built. You can build
